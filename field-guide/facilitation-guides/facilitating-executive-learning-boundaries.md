...
This facilitation guide supports a structured executive conversation about **where learning currently stops influencing decisions** in the organisation.
...
### 1. Framing the Session (10 minutes)
...
Participants complete the **Incremental & Reversible Commitment diagnostic** individually.
...
Do **not** review answers one by one.
...
> **“At what point does learning stop being allowed to change direction here?”**
...
> “Which of these constraints are designed — and which are inherited?”
...
Invite (voluntary) completion of this sentence:
...
It creates the **conditions under which change might later become rational**.
...
This session does not produce certainty.

It produces **clarity**.

In complex systems, that is the only legitimate starting point.
