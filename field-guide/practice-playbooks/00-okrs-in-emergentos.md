# Practice Playbook: OKRs in EmergentOS
...
OKRs are effective in EmergentOS *only if the following assumptions hold*:
...
> *If this strategy is sound, what change should we expect to observe?*
...
- **Aspirational OKRs** → *What have we learned?*  
- **High-Integrity Commitments** → *What risks remain and how are we mitigating them?*  
...
- expresses *why* the work matters
...
- *signals of progress*, not commitments
- *learning tools*, not success criteria
- *inputs to decisions*, not scorecards
...
Changing or stopping an OKR based on evidence is not failure.
Persisting without evidence is.
...
When this occurs, the issue is not OKRs.
It is a violation of EOS principles.
...
- *Who:* New users  
- *Does What:* Successfully onboard and reach first value  
- *By How Much:* Explicit, measurable change  
...
- *Who:* Customers and support teams  
- *Does What:* Experience fewer and shorter incidents  
- *By How Much:* Clear thresholds  
...
- Violates EOS principle: *metrics inform learning, not compliance*  
...
- *Who:* Delivery teams  
- *Does What:* Experience fewer and shorter blocking delays  
- *By How Much:* Observable system change  
...
- *Who:* Leadership and delivery teams  
- *Does What:* Gain earlier, higher-quality learning  
- *By How Much:* Clear improvement signals  
...
- *If we hit every Key Result, what would actually be different?*  
- *If we miss a Key Result, what would we learn?*  
- *Could this OKR be “achieved” without improving outcomes?*  
