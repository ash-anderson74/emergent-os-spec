...
- Bets are *not initiatives*
- Bets are strategic experiments
- Each bet assumes:  
  *If we invest here, we expect to move the outcome in this direction*
...
- Funding is not allocated *to* value streams blindly, but *through* them in service of bets
...
![lean-value-tree](../../images/lvt.png)
...
*If we reduce early friction and improve perceived value in the first month, customer retention will increase.*
