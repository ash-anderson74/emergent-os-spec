...
## Purpose of the Patterns Library

Patterns exist to:

- capture proven ways of thinking and working
- distill recurring solutions to common problems
- provide building blocks for adaptation
- support sensemaking without prescribing implementation
...
- names a recurring problem
- describes forces and tensions
- captures an effective response
- remains adaptable across contexts
...
Patterns require judgment to apply well.

---

## How to Use This Library

You may use the patterns in this library to:

- inspire change in part of a system
...
## Patterns, Practices, and Playbooks

Patterns occupy a different level of abstraction from practices.

- **Patterns** describe *what tends to be effective* and *why*  
- **Practices** describe *how a pattern might be applied*  
- **Playbooks** describe *how multiple practices interact over time*  

This library intentionally stays at the pattern level.

---

## In Summary

Patterns are not solutions to be installed.

They are lenses through which to see systems more clearly.

Use them with curiosity, not compliance.
